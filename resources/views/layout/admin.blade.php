  ...
  <nav class="custom-bg-primary">
            ...
            <ul class="flex space-x-4 items-center">
              ...
              @if (Auth::user()->role === 'administrador')
                <li><a href="{{ route('users.index') }}"
                    class="hover:bg-gray-700 text-white rounded-md px-3 py-2 text-sm font-medium">Usuarios</a></li>
              @endif
              <li><a href="{{ route('users.profile') }}"
                  class="hover:bg-gray-700 text-white rounded-md px-3 py-2 text-sm font-medium">Mi perfil</a></li>
              <li>
    ...
    <div class="hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2">
        <a href="{{ route('home') }}"
          class="hover:bg-gray-700 text-white block rounded-md px-3 py-2 text-base font-medium">Inicio</a>
        <a href="{{ route('admin.index') }}"
          class="hover:bg-gray-700 text-white block rounded-md px-3 py-2 text-base font-medium">Admin</a>
        <a href="{{ route('admin.blogs') }}"
          class="hover:bg-gray-700 text-white block rounded-md px-3 py-2 text-base font-medium">Blogs</a>
        @if (Auth::user()->role === 'administrador')
          <a href="{{ route('users.index') }}"
            class="hover:bg-gray-700 text-white block rounded-md px-3 py-2 text-base font-medium">Usuarios</a>
        @endif
        <form action="{{ route('auth.logout.post') }}" method="post">
          @csrf
          <button type="submit"
