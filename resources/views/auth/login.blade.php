...
@section('content')
  @if (\Session::has('status.login.message'))
    <div
      class="@if (\Session::has('status.error')) bg-red-100 border-red-400 text-red-700 @else bg-green-100 border-green-400 text-green-700 @endif border px-3 py-3 rounded relative my-5 form-user"
      role="alert">
