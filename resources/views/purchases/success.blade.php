...
@section('content')
  <div class="order-success py-8 sm:py-12 rounded-md">
    ...
    <h1 class="text-3xl mb-2">¡Hemos recibido tu pedido!</h1>
    <p class="text-xl">La compra del viaje a <a href="{{ route('services.service', ['id' => $service_id]) }}"
        title="{{ $service_name }}">{{ $service_name }}</a> se ha realizado con éxito</p>
  </div>
@endsection
