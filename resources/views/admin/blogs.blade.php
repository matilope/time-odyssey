            ...
            <div>
              ...
              <div>
                @if (Auth::user()->role === 'administrador')
                  ...
                  <button data-id="{{ $blog->id }}" data-title="{{ $blog->title }}" class="btn delete-btn"
                    type="button">
                    Eliminar
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                @else
                  <div class="bg-red-50 border-red-300 text-red-600 px-3 py-3 border rounded relative" role="alert">
                    <p class="block sm:inline">No tienes los permisos necesarios para realizar acciones en este <a
                        href="{{ route('blogs.article', ['id' => $blog->id]) }}" title="{{ $blog->title }}"
                        class="text-red-700 font-bold">blog</a></p>
                  </div>
                @endif
              </div>
            </div>
            ...
            <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
              <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  ...
                  <div class="mt-2">
                    <p class="text-sm text-gray-500 modal-message">¿Estas seguro de eliminar -? La eliminación sera
                      permanente.</p>
                  </div>
                </div>
              </div>
